<%-- 
    Document   : index
    Created on : 7 Ara 2023, 22:52:16
  ...
  <body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" tabindex="0">
    ...
    <div class="search-popup">
        <div class="search-popup-container">
          ...
          <h5 class="cat-list-title">Katagoriler</h5>
          
          <ul class="cat-list">
            <li class="cat-list-item">
              <a href="#" title="Mobile Phones">seri no:1</a>
            </li>
            <li class="cat-list-item">
              <a href="#" title="Smart Watches">seri no:2</a>
            </li>
            <li class="cat-list-item">
              <a href="#" title="Headphones">seri no:3</a>
            </li>
            <li class="cat-list-item">
              <a href="#" title="Accessories">seri no:4</a>
            </li>
            <li class="cat-list-item">
              <a href="#" title="Monitors">seri no:5</a>
            </li>
            <li class="cat-list-item">
      ...
      <nav id="header-nav" class="navbar navbar-expand-lg px-3 mb-3">
        <div class="container-fluid">
          <a class="navbar-brand" href="index.html">
            <img src="images/mains-logo.png" class="logo">
          </a>
          ...
          <div class="offcanvas offcanvas-end" tabindex="-1" id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel">
            ...
            <div class="offcanvas-body">
              <ul id="navbar" class="navbar-nav text-uppercase justify-content-end align-items-center flex-grow-1 pe-3">
                <li class="nav-item">
                  <a class="nav-link me-4 active" href="#billboard">Ana Sayfa</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link me-4" href="#company-services">İletişim</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link me-4" href="#mobile-products">Ürünler</a>
                </li>
                
                <li class="nav-item">
                  <a class="nav-link me-4" href="#yearly-sale">Misyonumuz</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li>
                      <a href="about.html" class="dropdown-item">Hakkında</a>
                    </li>
                    <li>
                      <a href="blog.html" class="dropdown-item">Blog</a>
                    </li>
                    <li>
                      <a href="shop.html" class="dropdown-item">Ürün Detayları</a>
                    </li>
                    <li>
              ...
              <div class="row d-flex align-items-center">
                <div class="col-md-6">
                  <div class="banner-content">
                    <h1 class="display-2 text-uppercase text-dark pb-5">Denizcilikte Yenilik.</h1>
                    <a href="shop.html" class="btn btn-medium btn-dark text-uppercase btn-rounded-none">Ürün Detayı</a>
                  </div>
                </div>
                <div class="col-md-5">
                  <div class="image-holder">
                    <img src="images/banner-images.png" alt="banner">
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="swiper-slide">
            <div class="container">
              <div class="row d-flex flex-wrap align-items-center">
                <div class="col-md-6">
                  <div class="banner-content">
                    <h1 class="display-2 text-uppercase text-dark pb-5">İnsansız Teknoloji</h1>
                    <a href="shop.html" class="btn btn-medium btn-dark text-uppercase btn-rounded-none">Ürün Detayları</a>
                  </div>
                </div>
                <div class="col-md-5">
                  <div class="image-holder">
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 pb-3">
            <div class="icon-box d-flex">
              ...
              <div class="icon-box-content">
                <h3 class="card-title text-uppercase text-dark">ÜCRETSİZ TESLİMAT</h3>
          ...
          <div class="col-lg-3 col-md-6 pb-3">
            <div class="icon-box d-flex">
              ...
              <div class="icon-box-content">
                <h3 class="card-title text-uppercase text-dark">KALİTE GARANTİSİ</h3>
          ...
          <div class="col-lg-3 col-md-6 pb-3">
            <div class="icon-box d-flex">
              ...
              <div class="icon-box-content">
                <h3 class="card-title text-uppercase text-dark">GÜNLÜK TEKLİFLER</h3>
          ...
          <div class="col-lg-3 col-md-6 pb-3">
            <div class="icon-box d-flex">
              ...
              <div class="icon-box-content">
                <h3 class="card-title text-uppercase text-dark">MÜŞTERİ HİZMETLERİ</h3>
      ...
      <div class="container">
        <div class="row">
          <div class="display-header d-flex justify-content-between pb-3">
            <h2 class="display-7 text-dark text-uppercase">ÜRÜNLERİMİZ</h2>
            <div class="btn-right">
    ...
    <section id="yearly-sale" class="bg-light-blue overflow-hidden mt-5 padding-xlarge" style="background-image: url('images/single-images1.png');background-position: right; background-repeat: no-repeat;">
      <div class="row d-flex flex-wrap align-items-center">
        <div class="col-md-6 col-sm-12">
          <div class="text-content offset-4 padding-medium">
            
            <h2 class="display-2 pb-5 text-uppercase text-dark">Yeni Ürün</h2>
            <a href="shop.html" class="btn btn-medium btn-dark text-uppercase btn-rounded-none">İNCELE</a>
          </div>
        </div>
        <div class="col-md-6 col-sm-12">
